...
**Website**
- [Repository](https://github.com/Elitezen/easy-trivia-website)
- [Website Link](https://elitezen.github.io/easy-trivia-website/)
...
Special thanks to [Turtlepaw](https://github.com/Turtlepaw)

# 🥠 Digital Fortune Cookies API
DFC is an Express API that serves fortunes along with randomly generated lucky numbers. Included are the Express API and NPM Module.
